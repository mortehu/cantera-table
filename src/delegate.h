...
struct hash<cantera::table::internal::Delegate<R(A...)>> {
  size_t operator()(cantera::table::internal::Delegate<R(A...)> const& d) const noexcept {
    auto const seed(hash<void*>()(d.object_ptr_));

    return hash<typename cantera::table::internal::Delegate<R(A...)>::stub_ptr_type>()(d.stub_ptr_) +
